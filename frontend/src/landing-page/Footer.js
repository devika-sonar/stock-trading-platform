    ...
    <div className="container border-top mt-5" >
      <div className="row mt-5" >
        ...
        <div className="col">
          ...
          <br />
          <a href="" className= "text-muted"style={{ textDecoration: "none"}} >NRI demat accounta</a>
          <br />
        ...
        <div className="col">
          ...
          <br />
          <a href="" className= "text-muted"style={{ textDecoration: "none"}} >Gift Nifty</a> <br />
        </div>
      </div>
      <div className="mt-5 text-small text-muted">
        ...
        <p className="text-muted">
          ...
          create a ticket here. *Customers availing insurance advisory services
          offered by Ditto (Tacterial Consulting Private Limited | IRDAI
          Registered Corporate Agent (Composite) License No CA0738) will not
